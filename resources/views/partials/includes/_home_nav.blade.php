    ...
    <div class="container " style="margin-right: 10em; padding-top: 1rem; padding-bottom: 1rem" >
        ...
        <ul class="nav justify-content-between menu-bar align-items-md-center" style="margin-left: 25em; margin-right: 2em">
            ...
            <li class="nav-item dropdown">
                <a id="navbarDropdown" class="nav-link dropdown-toggle nav-link d-flex flex-column font-weight-bolder {{ request()->url()==route('client.profile')?'text-primary':'tw-text-white' }}" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre style="background: #F4CE9B !important; border-radius: 50px; ">
                    <div class="symbol symbol-30 symbol-lg-30 symbol-circle ">
                        <img alt="Pic" src="{{ asset('storage/'.auth('client')->user()->profile_photo) ?  asset('storage/'.auth('client')->user()->profile_photo) : auth('client')->user()->profile_photo_url }}"
