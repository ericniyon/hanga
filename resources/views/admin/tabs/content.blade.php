    ...
    <div class="card card-custom gutter-b">
        <div class="card-header flex-wrap">
            <div class="card-title">
                <h3 class="card-label">Tabs List</h3>
            </div>
            <div class="card-toolbar">
                <!-- Button trigger modal-->
                <a href="{{ route('admin.create.content') }}" type="button" class="btn btn-primary">
        ...
        <div class="card-body">
            ...
            <table class="table table-head-solid table-head-custom" id="table">
                ...
                @foreach(\App\Models\FeatureContent::all() as $key=>$content)
