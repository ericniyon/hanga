            ...
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap">
                    <div class="card-title">
                        <h3 class="card-label">Create new content</h3>
                    </div>
                </div>
                <div class="card-body">
                    <!--begin: form-->
                    <form action="{{ route('admin.content.update',$content->id) }}" method="POST" id="WebinarForm"
                        ...
                        <div class="row mx-auto px-20">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="event_title">Tab Name</label>
                                    <select name="tab" id="tab" class="form-control">

                                    <option {{ old('tab') == 'Web/Mobile apps' ? 'selected' : '' }} value="Web/Mobile apps">Web/Mobile apps
                                    </option>

                                    <option {{ old('tab') == 'Tech Business' ? 'selected' : '' }} value="Tech Business">Tech Business</option>

                                        <option {{ old('tab') == 'Busines Directory' ? 'selected' : '' }} value="Busines Directory">Busines Directory
                                        </option>
                                        <option {{ old('tab') == 'iWorkers' ? 'selected' : '' }} value="iWorkers">
                                            iWorkers</option>
                                        <option {{ old('tab') == 'Digital Finance' ? 'selected' : '' }} value="Digital Finance">
                                            Digital Finance</option>
                                        <option {{ old('tab') == 'Events' ? 'selected' : '' }} value="Events">
                                            Events</option>
                                        <option {{ old('tab') == 'Discounts' ? 'selected' : '' }} value="Discounts">Discounts</option>
                                        <option {{ old('tab') == 'Opportunities' ? 'selected' : '' }} value="Opportunities">Opportunities</option>
                                        <option {{ old('tab') == 'News' ? 'selected' : '' }} value="News">News</option>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row mx-auto px-20 mt-4">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea id="summernote" name="content" class="form-control summernote" >{{ $content->content }}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row mx-auto px-20">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <button type="submit" class="btn btn-primary "><span
                                            class="la la-check-circle-o"></span> Update Content</button>
                                </div>
                            </div>
                        </div>
                    </form>
