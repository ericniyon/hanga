    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
            ...
            <div class="card card-custom gutter-b">
                ...
                <div class="card-body">
                    <!--begin: form-->
                    <form action="{{ route('admin.content.store') }}" method="POST" id="WebinarForm"
                        ...
                        <div class="row mx-auto px-20 mt-4">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea id="summernote" name="content" class="form-control summernote" required>{{ old('content') }}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row mx-auto px-20">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <button type="submit" class="btn btn-primary "><span
                                            class="la la-check-circle-o"></span> Save Content</button>
                                </div>
                            </div>
                        </div>
                    </form>
