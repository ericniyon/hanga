            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline mr-5">
                    ...
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('admin.general.reporting.index') }}" class="text-muted">Generate
                                Report</a>
                        </li>
                        <li class="breadcrumb-item">
    ...
    <div class="card card-custom gutter-b">
        ...
        <div class="card-header border-1 py-5">
            ...
            <div class="card-toolbar">
                <a href="{{route("admin.general.reporting.index")}}" class="btn btn-outline-primary btn-sm"><span
                ...
                &nbsp;&nbsp;<div class="btn-group">
                    ...
                    <div class="dropdown-menu" style="">
                        <a target="_blank" id="excel" href="{{request()->fullUrl()."&download=1"}}"
                           class="dropdown-item"
                           data-url=""> EXCEL
                        </a>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#kt_datatable1').DataTable({
                ...
                'order': [[0, 'desc']],
                lengthMenu: [[20, 25, 100, -1], [20, 25, 100, "All"]],
                pageLength: 20,
            });
        });
