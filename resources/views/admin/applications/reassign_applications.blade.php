        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-2 mr-5">Assigned Requests</h5>
                    <!--end::Page Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="javascript:void(0)" class="text-muted">Assigned Requests</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
    ...
    <div class="card card-custom gutter-b">
        ...
        <div class="card-header py-5 d-md-flex align-items-center justify-content-between">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label font-weight-bolder text-dark">Assigned Requests</span>
            </h3>
        </div>
        <!--end::Header-->
        <!--begin::Body-->
                    ...
                    @foreach($applications as $key=>$application)
                        <tr>
                            ...
                            <td>
                                ...
                                <td>
                                    {{$application->assignment->assignedTo->name}}
                                </td>
                            <td>
                ...
                @if(count($applications)>0)
                    <div class="pull-right p-2 my-5">
                        <a href="" data-toggle="modal"
                           ...
                           class="btn btn-outline-primary pull-right"><span class="la la-plus-circle"></span> Re-Assign
                            Application</a>
                    </div>
                @endif
...
@section('scripts')
    ...
    <script>
        ...
        $('.nav-assigned-applications').addClass('menu-item-active');
