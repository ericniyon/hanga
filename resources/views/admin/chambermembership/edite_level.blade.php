        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-2 mr-5">Membership Level</h5>
                    <!--end::Page Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a class="text-muted">Membership Level</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
            ...
            <div class="card card-custom gutter-b">
                ...
                <div class="card-body">
                    <!--begin: form-->
                        <form action="{{ route('admin.membershiplevel.update', $level->id) }}" method="POST" id="WebinarForm" enctype="multipart/form-data">
                            {{-- @method('PUT') --}}
                            @csrf
                                <div class="row mx-auto px-20 mt-4">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea id="summernote" name="name" class="form-control summernote" required>
                                                {{ $level->name }}
                                            </textarea>
                                        </div>
                                    </div>
                                ...
                                {{-- @dump($level->plan_id) --}}
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        @if (in_array($plan->id,$level->plan_id))
                                        checked
                                        @endif
                                        >
