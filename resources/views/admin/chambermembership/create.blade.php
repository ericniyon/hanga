...
@section("title","What is the Rwanda ICT Chamber Membership")
@section('css')
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-2 mr-5">What is the Rwanda ICT Chamber Membership</h5>
                    <!--end::Page Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a class="text-muted">What is the Rwanda ICT Chamber Membership</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
            ...
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap">
                    <div class="card-title">
                        <h3 class="card-label">What is the Rwanda ICT Chamber Membership ?</h3>
                    </div>
                </div>
                <div class="card-body">
                    <!--begin: form-->
                        <form action="{{ route('admin.what.is.ictchambermembership.save') }}" method="POST" id="WebinarForm" enctype="multipart/form-data">
                            @csrf
                                <div class="row mx-auto px-20 mt-4">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea id="summernote" name="what_is_ict_chamber_membership" class="form-control summernote" required>{{ old('what_is_ict_chamber_membership') }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mx-auto px-20">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-primary "><span class="la la-check-circle-o"></span> Save</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
