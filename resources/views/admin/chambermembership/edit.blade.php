    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
            ...
            <div class="card card-custom gutter-b">
                ...
                <div class="card-body">
                    <!--begin: form-->
                        <form action="{{ route('admin.what.is.ictchambermembership.update', $chamber->id) }}" method="POST" id="WebinarForm" enctype="multipart/form-data">
                            @csrf
                                <div class="row mx-auto px-20 mt-4">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea id="summernote" name="what_is_ict_chamber_membership" class="form-control summernote" required>
                                                {{ $chamber->what_is_ict_chamber_membership }}
                                            </textarea>
                                        </div>
                                    </div>
                                </div>
