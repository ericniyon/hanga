...
@section("title",'ICT CHAMBER PROGRAMS, PROJECTS & STRATEGIC ORIENTATION')
@section("css")
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-2 mr-5">ICT CHAMBER PROGRAMS, PROJECTS & STRATEGIC ORIENTATION</h5>
                    <!--end::Page Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="javascript:void(0)" class="text-muted">ICT CHAMBER PROGRAMS, PROJECTS & STRATEGIC ORIENTATION</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
    ...
    <div class="card card-custom gutter-b">
        ...
        <div class="card-header border-0 py-5">
            <h3 class="card-title align-items-start flex-column">
                ...
                <a href="{{ route('admin.strategic.strategic.create') }}" class="btn btn-primary">New Record</a>
            </div>
        </div>
        <!--end::Header-->
        <!--begin::Body-->
                ...
                <table class="table " id="kt_datatable1">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.strategic.edit', $item->id) }}">
                                    <i class="fa fa-edit text-info"></i>
                                </a>
                                <a href="{{ route('admin.strategic.delete', $item->id) }}" class="js-delete">
