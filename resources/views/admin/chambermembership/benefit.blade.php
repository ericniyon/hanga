        ...
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-1">
                ...
                <div class="d-flex align-items-baseline mr-5">
                    <!--begin::Page Title-->
                    <h5 class="text-dark font-weight-bold my-2 mr-5">Service Benefits</h5>
                    <!--end::Page Title-->
                    <!--begin::Breadcrumb-->
                    <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                        ...
                        <li class="breadcrumb-item">
                            <a href="javascript:void(0)" class="text-muted">Service Benefits</a>
                        </li>
                    </ul>
                    <!--end::Breadcrumb-->
                </div>
    ...
    <div class="card card-custom gutter-b">
        ...
        <div class="card-header border-0 py-5">
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label font-weight-bolder text-dark">Service Benefits</span>
                ...
                <a href="{{ route('admin.benefit.benefit.create') }}" class="btn btn-primary">New Record</a>
            </div>
        </div>
        <!--end::Header-->
        <!--begin::Body-->
            ...
            <div class="table-responsive">
                ...
                <table class="table " id="kt_datatable1">
                    ...
                    <tbody>
                        ...
                        @forelse (App\Models\ServiceBenefit::all() as $item)
                        <tr>
                            <td>#{{ $item->id }}</td>
                            <td>{{ $item->title }}</td>
                            ...
                            <td>
                                <a href="{{ route('admin.benefites.edit', $item->id) }}">
                                    <i class="fa fa-edit text-info"></i>
                                </a>
                                <a href="{{ route('admin.benefites.delete', $item->id) }}" class="js-delete">
