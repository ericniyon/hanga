                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group btn-group-sm">
                                        <a href="#" data-name="{{$service->name}}" data-date=""
                                           data-id="{{$service->id}}"
                                           data-kn="{{$service->name_kn}}"
                                           class="btn btn-primary js-edit"><span class="fa fa-edit"></span> Edit</a>
                                        <a href="{{route('admin.service.delete',$service->id)}}" class="btn btn-danger js-delete"><span
            ...
            <form action="{{route('admin.service.edit')}}" method="post" id="submissionFormEdit" class="submissionForm" enctype="multipart/form-data">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="name_en">Name (Kin)</label>
...
@section("scripts")
    <!-- Laravel Javascript Validation -->
        ...
        {!! JsValidator::formRequest(\App\Http\Requests\ValidateServices::class,'.submissionForm') !!}
    <script>
