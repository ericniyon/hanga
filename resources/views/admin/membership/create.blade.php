    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
            ...
            <div class="card card-custom gutter-b">
                ...
                <div class="card-body">
                    <!--begin: form-->
                        <form action="{{ route('admin.what.is.ictchamber.save') }}" method="POST" id="WebinarForm" enctype="multipart/form-data">
                            @csrf
                                <div class="row mx-auto px-20 mt-4">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea id="summernote" name="what_is_the_rwanda_ict_chamber" class="form-control summernote" required>{{ old('what_is_the_rwanda_ict_chamber') }}</textarea>
                                        </div>
                                    </div>
                                </div>
