        ...
        <div class="card-body py-0">
            ...
            <div class="table-responsive">
                ...
                <table class="table " id="kt_datatable1">
                    ...
                    <tr>
                        <th>#</th>
                        <th>What is the Rwanda ICT Chamber ?</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>#{{ $item->id }}</td>
                            <td>{!! $item->what_is_the_rwanda_ict_chamber !!}</td>
                            <td>
                                <a href="{{ route('admin.what.is.ictchamber.edit', $item->id) }}">
                                    <i class="fa fa-edit text-info"></i>
                                </a>
                                <a href="{{ route('admin.what.is.ictchamber.delete', $item->id) }}" class="js-delete">
