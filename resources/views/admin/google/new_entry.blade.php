            ...
            <div class="card card-custom gutter-b">
                <div class="card-header flex-wrap">
                    <div class="card-title">
                        <h3 class="card-label">Ratings Entry</h3>
                    </div>
                </div>
                <div class="card-body">
                    {{-- @forelse ($clients as $item)
                    {{ $item->application->client_id }}
                    @empty
                    ...
                    <!--begin: form-->
                            ...
                            @livewire('v2.ratings.new-rating')
                ...
                <div id="row${i}" class="row mx-auto px-20">
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="start_date">Reviewer Name:</label>
                            <input required type="text" name="full_name[]" class="form-control name_list" />
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            <label for="end_date">Customer Ratings:</label>
                            <input required type="text" name="cuastomer_rating[]" class="form-control name_list" />
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            <label for="end_date">Review Date:</label>
                            <input required type="datetime-local" name="review_date[]" class="form-control name_list" />
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="end_date">Feedback:</label>
                            <textarea rows="3" name="feedback[]" class="form-control" required></textarea>
                        </div>
                    </div>
