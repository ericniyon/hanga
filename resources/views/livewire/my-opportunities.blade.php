<div class="row my-5">
    ...
    <div class="col-md-4">
        <div class="d-flex justify-content-between align-items-center mb-5 h-50px">
            <h4 class="mb-0  d-flex justify-content-between align-items-center">
                <span><span class="svg-icon"> @include('partials.icons._filter')</span>@lang("app.Filter By")</span>
            </h4>
            <div wire:loading class="h-100">
        ...
        @foreach($opportunityTypes as $opportunityType)
            ...
            <path
                ...
                <label class="checkbox checkbox-info">
                    <input type="checkbox" value="{{ $opportunityType->id }}" wire:model="s_op_types"
    ...
    <div class="col-md-8">
        ...
        <div class=" h-50px">
            <div class="input-icon">
                ...
                <input type="search" class="form-control shadow-sm"
                       name="search" id="search" wire:model.debounce="search"
                       autocomplete="off"
                       placeholder="@lang("auth.search")"/>
        ...
        @if ($opportunities->count() >0)
            @foreach ($opportunities as $job)
                <x-opportunity-item :job="$job" :is_client="true"/>
            @endforeach

            @include('partials.includes._pagination', ['paginator' => $opportunities])

        @else
            <div class="alert alert-custom  alert-light-info mt-4 rounded-lg">
                <div class="alert-icon svg-icon-warning">
                            <span class="svg-icon">
