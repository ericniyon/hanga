<div>
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-md-7 border-right">
                <div class="row">
                    ...
                    {{-- <div class="form-group col-md-12">
                        <label for="validationCustom01" class="col-form-label pt-0"><span>*</span> Color</label>
                        <input class="form-control  @error('color') is-invalid @enderror" wire:model="color" id="validationCustom01" type="text" required>
                        @error('color')
                        <span class="invalid-feedback" role="alert">{{$message}}</span>
                    @enderror
                    </div> --}}
       ...
       @foreach($currentItems as $index=>$__item)
        ...
        <div class="row">
            <div class="col-md-12">
                <button type="button" wire:click.prevent="update" class="btn btn-success btn-sm">Submit</button>
            </div>
        </div>
