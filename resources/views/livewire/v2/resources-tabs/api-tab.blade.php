...
@if ($details)
@include('livewire/v2/single-resource')
@else
...
<div class="col-lg-12">
    ...
    <div class="row" style="justify-content: center">
        @forelse ($this->resources as $item)
        <div class="col-md-4">
            ...
            >
                ...
                height: 30em; padding: .7em">
                    <span class="font-weight-boldest text-dark font-size-lg mb-1 font-size-h5">
                                    {{ $item->resource_title }}
                    </span>
                ...
                <img class="w-md-125px w-100 h-125px object-contain align-self-start mr-md-2 rounded-lg shadow-sm" src="{{ asset('resources_covers/'.$item->resource_cover) ? asset('resources_covers/'.$item->resource_cover) : 'https://ui-avatars.com/api/?name=Eric+Niyo&amp;color=2A337E&amp;background=EDEFF3' }}" alt="">
                    ...
                    <p style="margin: auto">
                        {!! Str::limit($item->resource_description, 190, '...') !!}
                    </p>
