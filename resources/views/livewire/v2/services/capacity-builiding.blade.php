<div>
    ...
    @endif
    <div class="row p-5 flex justify-between">
        <div class="">
            <h5>Select your interest in Capacity Building</h5>
        </div>
        <div class="">
    ...
    <div class="row m-5 p-5">
        @forelse (App\Models\CapacityBuilidingItems::all() as $item)
            <div class="form-check form-check-inline custom-switch-xl">
                <input class="form-check-input" type="checkbox" wire:model.defer="capacity_builiding_items"
    ...
    <div class="row p-5">
        <div class="col-md-12">
            ...
            <h5 class="text-bold"><strong>Didn’t find capacity services you’re looking for ?</strong></h5>
        </div>
        <div class="col-md-12">
        ...
        <div class="col-md-12 ">
            ...
            <button style="float: right; border-radius: 50px" class="btn btn-primary px-20 py-3 " wire:click='save'>Submit</button>
