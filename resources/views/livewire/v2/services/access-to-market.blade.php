...
<div>
    ...
    <div class="row m-5 p-5">
            ...
            <div class="form-check form-check-inline custom-switch-xl">
                <input class="form-check-input" type="checkbox" wire:model.defer="access_to_market_interest_id"
    ...
    <div class="row p-5">
        ...
        <div class="col-md-12 ">
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="custom-file" >
                        <input type="file" class="custom-file-input" id="file" wire:model='image'
            ...
            <button style="float: right; border-radius: 50px" class="btn btn-primary px-20 py-3 " wire:click.prevent='save'>Submit</button>
