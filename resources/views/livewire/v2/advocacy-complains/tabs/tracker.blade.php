                    ...
                    <div class="row mt-5 justify-content-center">
                        ...
                        {{-- <div class="card border-0"> --}}
                           ...
                           <div class="card bg-light-light shadow-none rounded-0 my-2 border overflow-hidden">
                               ...
                               <div id="collapse3-{{ $item->id }}" class="collapse "
                                   ...
                                   <div class="card-body p-2 bg-white ">
                                       <div class="p-2">
                                           ...
                                           @include('partials/client/progress_steps', ['status' => $item->status])
                                               ...
                                               <div class="d-flex comment">
                                                  ...
                                                  <div class="flex-grow-1 ms-3">
                                                     <div class="mb-1"><a href="#" class="fw-bold link-dark me-1">
                                                        ...
                                                        {{ $item->name }}
                                                        @endforeach
                                                     </a> <span class="text-muted text-nowrap"> {{ \Carbon\Carbon::parse($item->created_at)->diffForHumans() }}  </span></div>
                                                     <div class="mb-2">
                            ...
                            @empty
                            <p class="text-center ">You haven't sent any complaint, issue or recommandation yet</p>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.0-beta1/dist/js/bootstrap.bundle.min.js" integrity="sha384-pprn3073KE6tl6bjs2QrFaJGz5/SUsLqktiwsUTF55Jfv3qYSDhgCecCxMW52nD2" crossorigin="anonymous"></script>
    ...
    {{-- @livewire('v2.advocacy-complains.reply-moder') --}}
