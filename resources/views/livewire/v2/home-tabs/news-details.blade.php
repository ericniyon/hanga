                            ...
                            @foreach ($articleCategories as $category)
                                ...
                                <div
                                    ...
                                    <label class="checkbox checkbox-info">
                                        <input type="checkbox" wire:model="interests.{{ $category->article_id }}"
                                            wire:click="checkMyInterest" value="{{ $category->article_id }}"
                                            {{ in_array($category->article_id, $interests) ? 'checked' : '' }}>
                            ...
                            <div style="display: block">
                                <div class="mx-4 my-4">
                                    <a href="http://127.0.0.1:8000/client/news">
                                        <p style="color: black;"> <i class="fa fa-arrow-left" aria-hidden="true"></i>
                                            Take Me
                                            Back</p>
                                    </a>
                                                    ...
                                                    <a href="#" title="Add article to my favourite"
                                                        ...
                                                        <svg width="20" height="33" viewBox="0 0 24 37"
                                                            ...
                                                            <path
                                                                ...
                                                                stroke="#5C5C5C" stroke-width="2"></path>
                                                        </svg>

                                                    </a><br>
                                                    <a href="#" title="Read article later"
                                                        wire:click="addArticleToread(2)">
                                    ...
                                    <div class="row mx-2 my-2">
                                        <div class="col-md-12 mt-5">
                                            <p>ihuzo news event for all msms word rhino day local stock continue to
                                                increase</p>
                                        </div>
                                    </div>
                                    <div class="row bg-white mx-2 my-2">
                                        <div class="col-md-8 mt-4">
                                            ...
                                            <p><strong>Herve</strong></p>
                                        </div>
                                        <div class="col-md-1 mt-4">
                                            <p class="float-right text-muted">
                                                <a href="#" wire:click="addArticleLike(2)">
                                        ...
                                        <div class="col-sm-2">
                                            <div
                                                ...
                                                <div class="symbol-label symbol-circle bg-light-primary text-primary font-weight-boldest"
                                                    style="background-image: url(https://ui-avatars.com/api/?name=Eric+Niyo&amp;color=2A337E&amp;background=EDEFF3);">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-2"><button class="btn btn-info" type="button"
                                                wire:click="addArticleComment(2)">Comment</button>
                                        </div>
                                    </div>
                                    <br>
                                            ...
                                            <div
                                                ...
                                                <div class="">
                                                    <img class="w-md-125px w-100 h-125px object-cover align-self-start mr-md-2 rounded-lg shadow-sm"
                                                        src="http://127.0.0.1:8000/images/v2/black.PNG"
                                                        alt="Logo">
                                                </div>
                                                <!--end::Symbol-->
                                                <!--begin::Section-->
                                                <div
                                                    ...
                                                    <!--begin::Title-->
                                                    <a href="http://127.0.0.1:8000/client/news/detail/2"
                                        ...
                                        <div class="col-xxl-6 col-md-6">
                                            ...
                                            <div
                                                ...
                                                <div
                                                    class="d-flex flex-column flex-grow-1 justify-content-center ml-2">
                                                    <!--begin::Title-->
                                                    <a href="http://127.0.0.1:8000/client/news/detail/3"
                                                        class="font-size-h5 text-hover-primary mb-1 ml-2"
                                                        style="color:#141414;">
                                                        Igihombo gikabije mubacuruzi kubwo kuzamurwa kwibiciro
                                                    </a>
                                                    <!--end::Title-->
                                                    <!--begin::Desc-->
                                                    <span class="ml-2"
                                                        style="font-size: 12px; font-family: Roboto; color: #282828; ">
                                                        Ibiciro bishya kwisoko
                                                    </span>
                                                    <!--begin::Desc-->
                                                    <small
                                                        style="padding:5px; font-size: 13px; color: #141414; font-family: Roboto;">
                                                        12:29 ,23rd Sep 22</small>
                                                    <div>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered modal-md">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body text-center">
                                                ...
                                                <div id="social-links">
                                                    <ul>
                                                        <li><a href="https://www.facebook.com/sharer/sharer.php?u=http://ihuzo.rw/client/news/detail/2"
                                                                class="social-button " id="" title=""
                                                                rel=""><span
                                                                    class="fab fa-facebook-square"></span></a></li>
                                                        <li><a href="https://twitter.com/intent/tweet?text=Inkuru+ishushanyije&amp;url=http://ihuzo.rw/client/news/detail/2"
                                                                class="social-button " id="" title=""
                                                                rel=""><span
                                                                    class="fab fa-twitter"></span></a></li>
                                                        <li><a href="https://www.linkedin.com/sharing/share-offsite?mini=true&amp;url=http://ihuzo.rw/client/news/detail/2&amp;title=Inkuru+ishushanyije&amp;summary="
                                                                class="social-button " id="" title=""
                                                                rel=""><span
                                                                    class="fab fa-linkedin"></span></a></li>
                                                        <li><a target="_blank"
                                                                href="https://wa.me/?text=http://ihuzo.rw/client/news/detail/2"
                                                                class="social-button " id="" title=""
                                                                rel=""><span
                                                                    class="fab fa-whatsapp"></span></a></li>
                                                        <li><a target="_blank"
                                                                href="https://telegram.me/share/url?url=http://ihuzo.rw/client/news/detail/2&amp;text=Inkuru+ishushanyije"
                                                                class="social-button " id="" title=""
                                                                rel=""><span
                                        ...
                                        @foreach ($businessSectors as $businessSector)
                                            <div class="col-md-4">
                                                <div class="checkbox-list">
                                                    <label class="checkbox checkbox-info">
                                                        <input type="checkbox"
                                                            wire:model="newsTags.{{ $businessSector->article_id }}"
                                                            value="{{ $businessSector->article_id }}">
                                                        {{ $businessSector->name }}
                                                        <span class="border-info border-2 rounded-sm"></span>
                                                    </label>
                                                </div>
                                        ...
                                        {{-- @foreach ($articleCategories as $category)
                                            <div class="col-md-4">
                                                <div class="checkbox-list">
                                                    <label class="checkbox checkbox-info">
                                                        <input type="checkbox"
                                                            wire:model="fieldOfInterest.{{ $category->article_id }}"
                                                            value="{{ $category->article_id }}"> {{ $category->name }}
                                                        <span class="border-info border-2 rounded-sm"></span>
                                                    </label>
                                                </div>
                                            </div>
                                        ...
                                        {{-- @foreach ($businessSectors as $businessSector)
                                            <div class="col-md-4">
                                                <div class="checkbox-list">
                                                    <label class="checkbox checkbox-info">
                                                        <input type="checkbox"
                                                            wire:model.defer="newsTags.{{ $businessSector->article_id }}"
                                                            value="{{ $businessSector->article_id }}"
                                                            {{ in_array($businessSector->article_id, $newsTagsEdit) ? 'checked' : '' }}>
                                                        {{ $businessSector->name }}
                                                        <span class="border-info border-2 rounded-sm"></span>
                                                    </label>
                                                </div>
                                    ...
                                    <div class="row">
                                        {{-- @foreach ($articleCategories as $category)
                                            <div class="col-md-4">
                                                <div class="checkbox-list">
                                                    <label class="checkbox checkbox-info">
                                                        {{ in_array($category->article_id, $fieldOfInterestEdit) ? 'checked' : '' }}
                                                        <input type="checkbox"
                                                            wire:model.defer="fieldOfInterest.{{ $category->article_id }}"
                                                            value="{{ $category->article_id }}"
                                                            {{ in_array($category->article_id, $fieldOfInterestEdit) ? 'checked' : '' }}>
                                                        {{ $category->name }}
                                                        <span class="border-info border-2 rounded-sm"></span>
                                                    </label>
