                    ...
                    <div class="card-body p-2 bg-white ">
                        <div class="form-group form-group-sm mb-1">
                            ...
                            <select wire:change="loadDistricts" wire:model="provinceId" name="province_id"
                                ...
                                <option value="0">
                                    -- {{ __('client_registration.choose') }} {{ __('client_registration.province') }}
                                    --
                                </option>
    ...
    <div class="col-lg-9">
        <div class="row  justify-content-center mb-5">
            ...
            <div class="col-md-12 " style="justify-content: center">
                @foreach(\App\Models\FeatureContent::where('tab','Busines Directory')->get() as $key=>$content)
                {!! $content->content !!}
                @endforeach
            </div>
        </div>
        <div class="row my-4 justify-content-center">
            ...
            @foreach($clients as $item)
                    @include('partials.includes._msme_dsp_item',[
                        'name'=>$item->application->msmeRegistration->company_name??$item->name])
                @endforeach
