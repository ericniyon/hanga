<section class="pb-20">
  <nav class="navbar navbar-expand-lg navbar-light bg-light"  >
    <div class="container"><a class="navbar-brand" href="#"><img class="img-fluid" src="flaro-assets/logos/flaro-logo-black.svg" alt=""/></a>
      ...
      <div class="d-none d-lg-block"><a class="btn btn-primary" href="#" >Try 14 Days Free Trial</a></div>
      <div class="d-lg-none">
  ...
  <div class="container position-relative">
    <div class="row align-items-center">
      <div class="col-12 col-lg-6 pt-24">
        <div class="mw-xl mw-lg-2xl mx-auto mx-lg-0"><a class="btn d-inline-flex px-2 py-1 mb-6 align-items-center btn-success-light rounded-pill" href="#"><span class="me-1 fw-semibold" >👋 We are hiring. View open roles</span>
          ...
          <h1 class="h2 mb-6" >Discover mentors that helps you grow</h1>
          <p class="mw-lg fs-7 mb-10" >Get the best-in-class group mentoring plans and professional benefits for your team.</p>
          <div class="d-sm-flex align-items-center mb-24"><a class="btn d-block d-sm-inline-block mb-4 mb-sm-0 me-sm-6 btn-primary" href="#" >Join Free for 30 Days</a><a class="btn d-block d-sm-inline-block btn-outline-light-dark" href="#">
              ...
              </svg><span class="ms-1 text-black fw-medium" >Book a call</span></a></div>
          <p class="fs-8 fw-semibold text-secondary mb-6" >TRUSTED AND LOVED BY 100+ TECH FIRST TEAMS</p>
          <div class="d-flex flex-column flex-sm-row align-items-center"><img class="mb-5 mb-sm-0 me-sm-6" src="flaro-assets/logos/brands/brand.png" alt=""/><img class="mb-5 mb-sm-0 me-sm-6" src="flaro-assets/logos/brands/brand2.png" alt=""/><img src="flaro-assets/logos/brands/brand3.png" alt=""/></div>
        </div>
      </div>
      <div class="col-12 col-lg-6 pt-24">
        <div class="mw-2xl mx-auto"><img class="img-fluid" src="flaro-assets/images/headers/header.png" alt="header"/></div>
      </div>
    </div>
  </div>
  <div class="d-none navbar-menu position-fixed top-0 start-0 bottom-0 w-75 mw-xs" style="z-index: 9999;"  >
    ...
    <nav class="position-relative h-100 w-100 d-flex flex-column justify-content-between py-8 px-8 bg-white overflow-auto">
      <div class="d-flex align-items-center"><a class="me-auto h4 mb-0 text-decoration-none" href="#"><img class="img-fluid" src="flaro-assets/logos/flaro-logo-black.svg" alt=""/></a><a class="navbar-close" href="#">
