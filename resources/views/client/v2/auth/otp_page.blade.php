                ...
                <div class="card border-0 rounded-lg shadow position-relative px-md-20  pt-md-20 px-3  overflow-hidden"
                    ...
                    <div class="text-center text-white" style="z-index: 21">
                        ...
                        <div class="rounded-lg custom-shadow  overflow-hidden"
                            ...
                            <ul class="nav nav-pills bg-white mb-3 nav-justified nav-fill" id="pills-tab"
                                role="tablist">
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="login" role="tabpanel"
                                    ...
                                    <form action="{{ route('v2.otp.verify') }}"
                                          method="post"
                                          class="p-5 p-md-10">
                                        @csrf
                                        ...
                                        <div class="text-center mt-10 w-100 min-h-55px d-flex justify-content-center">
                                            <p class="text-center h6 text-info  max-w-300px ">
                                                {!! __('client_registration.receive_otp_title',['phone' =>'---'.substr($client->phone, -4) ,'email' => '---'.$email_exploded ]) !!}
                                            </p>
