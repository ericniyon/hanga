        ...
        <div class="card card-custom gutter-b">
            <div class="card-header flex-wrap">
                ...
                <div class="card-title" style="display: flex">
                    ...
                    <h3 class="card-label">New Partner</h3>

                </div>

            </div>
            <div class="table-responsive">
                <form action="{{ route('admin.save.partner') }}" method="POST" enctype="multipart/form-data" class="submissionForm p-5">
                    @csrf
                    <div class="row">
                        <div class="col-md-12">

                            <input type="file" name="logo" id="" placeholder="Partner Logo" class="form-control">
                        </div>
