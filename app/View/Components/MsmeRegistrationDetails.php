...
class MsmeRegistrationDetails extends Component
{
    ...
    public bool $review;
    public StartupCompanyProfile $model;
     ...
     * @return void
     */
    public function __construct(StartupCompanyProfile $model, bool $editable = false, $cardClasses = 'border-0', bool $review = false)
    {
        $this->model = $model;
    ...
    public function render(): View
    {
        ...
        return view('components.msme-registration-details', compact('application', 'registrationTypes'));
    }
}
