...
class DSPRegistrationController extends Controller
{
    ...
    public function index()
    {
        ...
        return view(
            'frontend.dsp.dsp_application_form',
    ...
    public function details(Application $application)
    {
        ...
        return \view('frontend.dsp.dsp_application_details', compact(
            'model',
            'businessSectors',
            'application',
            'history',
    ...
    public function editCompanyService(){
    ...
    public function editCompanyInterests(){
    ...
    public function updateeIdentification(Request $request, DSPRegistration $model)
    {
